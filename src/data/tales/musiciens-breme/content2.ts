...
export const musiciensBremContent2: TaleSegment[] = [
  {
  ...
  {
    text: "Et comme ils étaient fatigués de leur long trajet, ils s'endormirent aussitôt.\n\nQuand minuit fut passé, les voleurs virent de loin que la lumière avait été éteinte dans la maison et que tout y paraissait tranquille. Leur capitaine dit :\n- Nous n'aurions pas dû nous laisser mettre à la porte comme ça.",
    image: "/lovable-uploads/musiciens-breme-15.png"
  },
  {
    text: "Il ordonna à l'un de ses hommes d'aller inspecter la maison. L'éclaireur vit que tout était silencieux ; il entra à la cuisine pour allumer une lumière. Voyant les yeux du chat brillants comme des braises, il en approcha une allumette et voulut l'enflammer. Le chat ne comprit pas la plaisanterie et, crachant et griffant, lui sauta au visage.",
    image: "/lovable-uploads/musiciens-breme-16.png"
  },
  {
