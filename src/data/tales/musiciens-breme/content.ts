...
export const musiciensBremContent: TaleSegment[] = [
  {
    text: "Un meunier possédait un âne qui, durant de longues années, avait inlassablement porté des sacs au moulin, mais dont les forces commençaient à décliner. Il devenait de plus en plus inapte au travail. Son maître songea à s'en débarrasser.\n\nL'âne se rendit compte qu'un vent défavorable commençait à souffler pour lui et il s'enfuit. Il prit la route de Brême. Il pensait qu'il pourrait y devenir musicien au service de la municipalité.",
