...
export const loupChevreaux: Tale = {
  ...
  content: [
    {
      text: "Il était une fois une vieille chèvre qui avait sept chevreaux et les aimait comme chaque mère aime ses enfants. Un jour, elle voulut aller dans la forêt pour rapporter quelque chose à manger, elle les rassembla tous les sept et leur dit de se méfier du loup.",
      image: "/lovable-uploads/loup-chevreaux-1.png",
      imagePrompt: "A mother goat warning her seven kids about the wolf, in a cozy cottage setting."
    },
    {
  ...
  moral: "Il faut toujours écouter les conseils de ses parents et se méfier des apparences trompeuses."
};